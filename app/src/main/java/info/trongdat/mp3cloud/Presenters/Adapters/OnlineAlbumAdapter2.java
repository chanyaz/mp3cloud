...
public class OnlineAlbumAdapter2 extends RecyclerView.Adapter<OnlineAlbumAdapter2.ViewHolder> {
    SQLiteHandler db;
    private Context mContext;
    private ArrayList<OnlineAlbum> albums;

    public OnlineAlbumAdapter2(Context context, ArrayList<OnlineAlbum> dataSet) {
        mContext = context;
        albums = dataSet;
