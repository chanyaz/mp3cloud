...
public class HotSongMore extends AppCompatActivity {
    ...
    public void initialize() {
        ...
        txtAlbum.setText("Playlist chọn lọc nhạc hot");
        GridLayoutManager gridAlbum = new GridLayoutManager(HotSongMore.this, 2, GridLayoutManager.VERTICAL, false);
...
//        Log.d(Introduction.TAG, "loadAlbum: ddddd" + adapter.getItem(position).getName());
        AlbumAsyncTask loadAlbum = new AlbumAsyncTask(new AlbumLoadListener() {
            ...
            public void AlbumLoadListener(ArrayList<OnlineAlbum> list) {
                OnlineAlbumAdapter3 adapter = new OnlineAlbumAdapter3(HotSongMore.this, list);
                lstPlaylist.setAdapter(adapter);
            }
        });
        loadAlbum.execute("http://mp3.zing.vn/chu-de/nhac-viet-hot/IWZ9Z0C8.html?view=playlist");
    }
