...
public class PlaylistTop100 extends AppCompatActivity {
    ...
    public void initialize() {
        ...
        txtAlbum.setText("TOP 100");
        GridLayoutManager gridAlbum = new GridLayoutManager(PlaylistTop100.this, 2, GridLayoutManager.VERTICAL, false);
...
//        Log.d(Introduction.TAG, "loadAlbum: ddddd" + adapter.getItem(position).getName());
        AlbumAsyncTask loadAlbum = new AlbumAsyncTask(new AlbumLoadListener() {
            ...
            public void AlbumLoadListener(ArrayList<OnlineAlbum> list) {
                OnlineAlbumAdapter3 adapter = new OnlineAlbumAdapter3(PlaylistTop100.this, list);
                lstPlaylist.setAdapter(adapter);
            }
        });
        loadAlbum.execute("http://mp3.zing.vn/chu-de/Top-100-Hay-Nhat/IWZ9ZI68.html?view=playlist");
    }
